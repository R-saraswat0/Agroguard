...
>
  ...
  {validationErrors.email && (
    ...
    <div className="flex">
      <div className="shadow-lg my-1 border rounded-l w-1/3 py-3 px-4 text-gray-700 bg-gray-100 flex items-center justify-center font-semibold">
        +91
      </div>
      <input
          ...
          <div className="flex justify-between gap-4">
            ...
            <div className="w-full">
              ...
              >
                ...
                {["Afghanistan", "Albania", "Algeria", "Argentina", "Australia", "Bangladesh", "Brazil", "Canada", "China", "Egypt", "France", "Germany", "Indonesia", "Italy", "Japan", "Malaysia", "Mexico", "Pakistan", "Russia", "Saudi Arabia", "South Africa", "South Korea", "Spain", "Sri Lanka", "Thailand", "Turkey", "United Arab Emirates", "United Kingdom", "United States"].map((country) => (
